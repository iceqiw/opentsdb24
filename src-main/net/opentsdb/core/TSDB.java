...
public final class TSDB {
  ...
  public TSDB(final HBaseClient client, final Config config) {
    ...
    if (config.getBoolean("tsd.core.uid.random_metrics")) {
      ...
      tag_names = new UniqueId(this, uidtable, TAG_NAME_QUAL, TAG_NAME_WIDTH, true);
      tag_values = new UniqueId(this, uidtable, TAG_VALUE_QUAL, TAG_VALUE_WIDTH, true);
    } else {
  ...
  public void collectStats(final StatsCollector collector) {
    ...
    try {
      ...
      if (config.getBoolean("tsd.core.uid.random_metrics")) {
        ...
        collector.record("uid.ids-used", 0, "kind=" + TAG_NAME_QUAL);
        collector.record("uid.ids-available", 0, "kind=" + TAG_NAME_QUAL);
        collector.record("uid.ids-used", 0, "kind=" + TAG_VALUE_QUAL);
        collector.record("uid.ids-available", 0, "kind=" + TAG_VALUE_QUAL);
      } else {
